...
Bakdelen med dette er at det tar lang tid å trene opp samtidig som opptrening er
en kostbar prosess. Med _KBS_ bruker vi deler av [kontekstvinduet][openai_token]
(se @def-kontekst) til å fylle inn informasjon fra en kunnskapsbase. Dette gir
språkmodellen tilgang til ekstra informasjon, man slipper å dele kunnskapsbasen
med tilbyder av språkmodellen samtidig som det har vist seg å [redusere
hallusinering[^2] for språkmodellen][rag_paper].  Samtidig gjør det at
kunnskapsbasen og språkmodellen kan utvikle seg uavhengig av hverandre og
...
produsert for å sammenligne innholdet i de forskjellige media.
