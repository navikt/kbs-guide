...
at språkmodellen trenger å endre seg. I @fig-rag-overview er det illustrert
hvordan flyten går fra bruker stiller spørsmål til språkmodellen som bruker både
spørsmålet samt relevante dokumenter som input for å generere et svar.
...
Hvordan søke utføres vil ha stor innvirkning på kvaliteten på det genererte
...
en [embedding modell][wiki_embedding]. I @fig-rag-vector-database er det
illustrert hvordan kunnskapsbasen og vektordatabasen henger sammen for å hente
frem relevant kontekst for spårkmodellen. I figuren vises sammenhengen mellom
embedding modellen og vektordatabasen, både indeksen til vektordatabasen blir
laget på bakgrunn av embedding modellen samtidig som spørsmålet til brukeren går
gjennom embedding modellen for å søke i vektordatabasen.
