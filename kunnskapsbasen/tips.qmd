...
For hver testcase finnes først ranken til den høyest scorede korrekte teksten. Reciprocal rank er definert som 1/rank, så dersom korrekt artikkel er rangert som nummer 1 vil reciprocal rank være 1. Dersom korrekt artikkel er rangert som nummer 2 vil reciprocal rank være 1/2 osv. Den samlede MRR-scoren er gjennomsnittet av disse rank-scorene per case. 

### Fordeler og ulemper
Fordelen med `hit rate` og `mean reciprocal rank` er at de begge de begge er enkle å forstå og implementere. 
...
- (Kommer) Sammenligning av forskjellige vektordatabaser på NKS
sin kunnskapsbase (ekstern datafortelling)