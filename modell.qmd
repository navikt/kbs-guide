...
### Hente dokumenter {#sec-retrieve-node}

:::{.callout-tip}
## Verktøykalling
Et alternativ til å ha en egen node i kjøretidsgrafen som henter informasjon er
å bruke verktøykall (forklart i @sec-tool-calling). Verktøykall er en kraftig
generell teknikk som kan brukes til mange formål (ikke bare til å hente
informasjon). **Det anbefales derfor å gjøre seg kjent med verktøykalling før
man designer resten av kjøretidsgrafen.**
:::
