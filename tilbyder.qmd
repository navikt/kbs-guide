...
-   [`LangChain`](https://www.langchain.com) - Et rammeverk for å skape språkmodell-baserte applikasjoner.
    -   Har støtte for de fleste tilbydere og man kan gjennom dette rammeverket kalle på Azure OpenAI og Vertex AI modeller.
-   API direkte - her binder man seg til en tilbyder, men man har fortsatt mer kontroll over hele applikasjonen
...
på veldig fort jevne seg ut[^tilbyder-1].
:::
...
+-------------------------+----------------------------------------------------+----------------------------------------------+
| BigQuery                | -   Enkel tilgang for NAV                          | -   Låser til Google GCP [^2]                |
...
[^2]: BigQuery er en proprietær løsning fra Google og er ikke nødvendigvis
overførbar til andre SQL løsninger.
